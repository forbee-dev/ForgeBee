...
│   └── scripts/             # 19 lifecycle hook scripts (Node.js)
...
- **69 specialist agents** — dev, debate, strategy, growth OS, review sub-agents
- **19 lifecycle hook scripts** across 9 events — session management, quality gates, observation

...
echo ""
echo "   COMMANDS (24 slash commands):"
echo "   • Plan:   /plan"
...
echo ""
echo "   AGENTS (26 specialists for Agent Teams):"
echo "   • Design:   ux-designer, scrum-master"
echo "   • Debate:   requirements-advocate/skeptic/judge, code-advocate/skeptic/judge"
